    ...
    <div className="min-h-screen  ">
      ...
      <div className="relative">
        ...
        <a
          ...
          className="bg-rab-navy hover:bg-rab-green lg:hidden z-20 fixed bottom-10 hover:scale-110 transition-all  shadow-2xl right-6 group gap-2 items-center text-white hoverbrightness-125 py-4 px-4 rounded-full ml-4"
        >
